...
class UbicacionsControllerTest < ActionController::TestCase
  ...
  test "should create ubicacion" do
    assert_difference('Ubicacion.count') do
      post :create, ubicacion: { descripcion: @ubicacion.descripcion, direccion: @ubicacion.direccion, iniciales: @ubicacion.iniciales, maps: @ubicacion.maps, name: @ubicacion.name }
    end
  ...
  test "should update ubicacion" do
    patch :update, id: @ubicacion, ubicacion: { descripcion: @ubicacion.descripcion, direccion: @ubicacion.direccion, iniciales: @ubicacion.iniciales, maps: @ubicacion.maps, name: @ubicacion.name }
    assert_redirected_to ubicacion_path(assigns(:ubicacion))
  end
